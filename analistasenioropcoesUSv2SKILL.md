...
P\&L ≈ ½·Γ·S²·(σ\_realizada² − σ\_implícita²)·T
...
GEX\_strike \= \[Γ\_call·OI\_call·100·S²·0,01\] − \[Γ\_put·OI\_put·100·S²·0,01\]

GEX\_total  \= Σ GEX\_strike        → dividir por 1.000.000 para expressar em US$ milhões
...
REGIME GEX: \[+GEX estável / −GEX explosivo\] | Zero flip: $XX.XX | Put wall: $XX.XX | Call wall: $XX.XX
   ...
   (fonte do OI e convenção de sinal: \_\_\_\_\_\_)
